...
import { Mail, Lock, Eye, EyeOff, Sprout, ArrowRight, AlertCircle } from 'lucide-react';
...
const LoginPage = () => {
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 dark:from-gray-950 dark:to-gray-900 flex items-center justify-center">
