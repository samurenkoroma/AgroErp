...
import {useVarietyPage} from "@/features/crops/hooks/useVarietyPage.ts";

const VarietyDetailsPage = () => {
    const navigate = useNavigate();

    const {variety, cropId} = useVarietyPage();
        ...
        <div className="flex-1 overflow-y-auto bg-background text-foreground pb-12">
            <div className="w-full mx-auto px-6 py-8">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div className="bg-background p-4 rounded-xl">
                                        ...
                                        <p className="text-2xl font-bold text-foreground">
                                            {variety?.water_requirement.daily_need_min} <span
                                    ...
                                    <div className="bg-background p-4 rounded-xl">
                                        ...
                                        <p className="text-2xl font-bold text-green-600">
                                            {variety?.water_requirement.daily_need_opt} <span
                                            className="text-sm font-normal">л/м²/день</span>
                                        </p>
                                    </div>
                                </div>

                                {variety?.water_requirement.critical_phases?.length > 0 && (
                                        ...
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2 mt-2">
                                                    {variety?.water_requirement.critical_phases.map((phase: string) => (
                                                        <span key={phase}
                            ...
                            <div className="bg-card p-6 rounded-2xl border border-border shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div className="bg-background p-4 rounded-xl">
                                        ...
                                        <p className="text-2xl font-bold text-foreground">
                                            {variety.light_requirement.ppfd_min} <span
                                    ...
                                    <div className="bg-background p-4 rounded-xl">
                                        ...
                                        <p className="text-2xl font-bold text-green-600">
                                            {variety.light_requirement.ppfd_opt} <span
                                            className="text-sm font-normal">μmol/m²/s</span>
                                        </p>
                                    </div>
                                    <div className="bg-background p-4 rounded-xl">
                                        ...
                                        <p className="text-2xl font-bold text-foreground">
                                            {variety.light_requirement.day_length_min} <span
                                    ...
                                    <div className="bg-background p-4 rounded-xl">
                                        ...
                                        <p className="text-2xl font-bold text-green-600">
                                            {variety.light_requirement.day_length_opt} <span
                                            className="text-sm font-normal">часов</span>
                                        </p>
                                    </div>
                                </div>
                    ...
                    {variety.light_requirement.photoperiod_type === 'short_day' && 'Короткодневное растение'}
                                            {variety.light_requirement.photoperiod_type === 'long_day' && 'Длиннодневное растение'}
                                            {variety.light_requirement.photoperiod_type === 'day_neutral' && 'Нейтральное растение'}
                </span>
                                    </div>
                                    <p className="text-xs text-blue-700 dark:text-blue-400 mt-2">
                                        {variety.light_requirement.photoperiod_type === 'short_day' && 'Цветет при коротком световом дне (<12 часов)'}
                                        {variety.light_requirement.photoperiod_type === 'long_day' && 'Цветет при длинном световом дне (>14 часов)'}
                                        {variety.light_requirement.photoperiod_type === 'day_neutral' && 'Цветение не зависит от длины светового дня'}
                                    </p>
                                </div>

                                {variety.light_requirement.critical_phases?.length > 0 && (
                                    <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4">
                                        <div className="flex items-start gap-2">
                                            <AlertCircle className="w-4 h-4 text-amber-600 mt-0.5"/>
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2 mt-2">
                                                    {variety.light_requirement.critical_phases.map((phase: string) => (
                                                        <span key={phase}
                                                              className="px-2 py-1 bg-amber-100 dark:bg-amber-800 text-amber-800 dark:text-amber-200 rounded-lg text-xs">
                                    {phase}
                                </span>
