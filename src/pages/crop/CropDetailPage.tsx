...
import {useCropTypePage} from "@/features/crops/hooks/useCropTypePage.ts";
...
const CropDetailsPage = () => {
    ...
    const {crop, varieties, error, isLoading} = useCropTypePage();

    if (isLoading) return (<Loading text="Загрузка теплицы..."/>);
    if (error || !crop || !varieties) return (<Error text="Теплица не найдена"/>);
